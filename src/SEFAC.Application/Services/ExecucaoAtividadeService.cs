...
{
    public class ExecucaoAtividadeService : IExecucaoAtividadeService
    {
        private readonly IExecucaoAtividadeRepository _atividadeRepository;
        private readonly IMapper _mapper;

        #region Ctor
        public ExecucaoAtividadeService(IExecucaoAtividadeRepository atividadeRepository, IMapper mapper)
        {
        ...
        public async Task<int> CadastrarAtividade(CadastrarExecucaoAtividadeDto cadastrarAtividadeDto)
        {
